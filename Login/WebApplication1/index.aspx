		...
		<!-- Header -->
			<div id="header">
				<div class="container">
					...
					<!-- Logo -->
						<h1><a href="#" id="logo"><span id="result_box0" class="short_text" lang="es"><span class="">Alegria Enbotellada</span></span></a></h1>
					...
					<!-- Banner -->
						<div id="banner">
							<div class="container">
								<section>
									<header class="major">
										<h2><span id="result_box" class="short_text" lang="es"><span class="">Bienvenido a Alegria Enbotellada</span></span>!</h2>
